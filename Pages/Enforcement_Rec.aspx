<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Enforcement_Rec.aspx.cs" Inherits="Pages_Enforcement_Rec" %>
...
<head id="Head1" runat="server">
    ...
    <title>DCRC - Enforcement Receiving</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="form-panel">
            <h2 style="text-align:center;">Enforcement - Receiving</h2>
