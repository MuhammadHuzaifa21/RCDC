...
<head id="Head1" runat="server">
    ...
    <style>
        ...
        .approved-reconnect-row {
            background-color: #cffbb8 !important;
        }
            ...
            <div class="form-panel" id="formPanel" runat="server">
                <div class="top-bar">
                    ...
                    <div class="count-section">
                        ...
                        <asp:LinkButton ID="btnExportDC" runat="server" CssClass="count-box export-btn"
                            OnClick="btnExportDC_Click">

                            <span class="default-text">DC:
                                <asp:Label ID="lblDCCount" runat="server" />
                            </span>
