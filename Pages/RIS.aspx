<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RIS.aspx.cs" Inherits="Pages_RIS" %>
...
<head id="Head1" runat="server">
    ...
    <style>
        ...
        .grid-container::-webkit-scrollbar { width: 12px; }
        .grid-container::-webkit-scrollbar-track { background: #f1f1f1; }
        .grid-container::-webkit-scrollbar-thumb { background: #888; border-radius: 6px; } 
        ...
        @media (max-width: 768px){
            ...
            .grid-container{ max-height: 220px; }
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="form-panel">
            <h2 style="text-align:center;">RIS - Charges</h2>
            ...
            <div class="record-card">
                ...
                <div class="row"> 
                    <div class="col"> 
                        ...
                        <%--<asp:TextBox ID="txtRemarks" runat="server" CssClass="input-remarks" Rows="3" Wrap="true"></asp:TextBox>--%>
                        <asp:TextBox 
                            ID="txtRemarks" 
                            runat="server" 
                            CssClass="input-remarks"
                            TextMode="MultiLine"
                            Rows="3" />
                    </div> 
                </div>
