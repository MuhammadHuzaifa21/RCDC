<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Security.aspx.cs" Inherits="Pages_Security" %>
...
<head id="Head1" runat="server">
    ...
    <title>DCRC - Security Charges</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="form-panel">
            <h2 style="text-align:center;">Security - Charges</h2>
